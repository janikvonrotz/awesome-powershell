...
- [posh-vsts-cli](https://github.com/bergmeister/posh-vsts-cli/) - Wraps the [vsts-cli](https://github.com/Microsoft/vsts-cli), converts the output to structured objects and adds tab completion to it.
