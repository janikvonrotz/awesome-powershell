...
* [Mastering PowerShell](https://www.bonusbits.com/uploads/Mastering-PowerShell.pdf) - a free eBook that covers everything required to become self-sufficient using PowerShell 
